...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.addContact(ContactType.SKYPE, "grigory.kislin"); // "skype:grigory.kislin"
        resume.addContact(ContactType.EMAIL, "gkislin@yandex.ru"); // "gkislin@yandex.ru"
        ...
        resume.addSection(SectionType.OBJECTIVE, new StringSection("Ведущий стажировок и корпоративного обучения " +
                "по Java Web и Enterprise технологиям"));

        resume.addSection(SectionType.PERSONAL, new StringSection("Аналитический склад ума, сильная логика, " +
        ...
        resume.addSection(SectionType.ACHIEVEMENT, new ListSection(achievementContent));
        ...
        resume.addSection(SectionType.QUALIFICATIONS, new ListSection(qualificationsContent));
        ...
        resume.addSection(SectionType.EXPERIENCE, new OrganizationSection(experienceContent));
        ...
        resume.addSection(SectionType.EDUCATION, new OrganizationSection(educationContent));
