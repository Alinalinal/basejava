...
public class ResumeTestData {
    ...
    public static Resume getCompletedResume(String uuid, String fullName) {
        ...
        positions1.add(new Position(DateUtil.of(2014, Month.OCTOBER), DateUtil.of(2016, Month.JANUARY),
        ...
        Organization organization1 = new Organization("Java Online Projects", "http://javaops.ru/", positions1);
        List<Position> positions2 = new ArrayList<>();
        positions2.add(new Position(DateUtil.of(2014, Month.OCTOBER), DateUtil.of(2016, Month.JANUARY),
                "Старший разработчик (backend)", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."));
        Organization organization2 = new Organization("Wrike", "https://www.wrike.com/", positions2);
        List<Position> positions3 = new ArrayList<>();
        positions3.add(new Position(DateUtil.of(2012, Month.APRIL), DateUtil.of(2014, Month.OCTOBER),
        ...
        Organization organization3 = new Organization("RIT Center", null, positions3);
        List<Position> positions4 = new ArrayList<>();
        positions4.add(new Position(DateUtil.of(2010, Month.DECEMBER), DateUtil.of(2012, Month.APRIL),
        ...
        positions5.add(new Position(DateUtil.of(2008, Month.JUNE), DateUtil.of(2010, Month.DECEMBER),
        ...
        Organization organization5 = new Organization("Yota", "https://www.yota.ru/", positions5);
        List<Position> positions6 = new ArrayList<>();
        positions6.add(new Position(DateUtil.of(2007, Month.MARCH), DateUtil.of(2008, Month.JUNE),
        ...
        Organization organization6 = new Organization("Enkata", "http://enkata.com/", positions6);
        List<Position> positions7 = new ArrayList<>();
        positions7.add(new Position(DateUtil.of(2005, Month.JANUARY), DateUtil.of(2007, Month.FEBRUARY),
        ...
        Organization organization7 = new Organization("Siemens AG", "https://www.siemens.com/ru/ru/home.html",
                positions7);
        List<Position> positions8 = new ArrayList<>();
        positions8.add(new Position(DateUtil.of(1997, Month.SEPTEMBER), DateUtil.of(2005, Month.JANUARY),
        ...
        Organization organization8 = new Organization("Alcatel", "http://www.alcatel.ru/", positions8);
        ...
        // Образование
        List<Position> positions11 = new ArrayList<>();
        positions11.add(new Position(DateUtil.of(2013, Month.MARCH), DateUtil.of(2013, Month.MAY),
                "\"Functional Programming Principles in Scala\" by Martin Odersky", null));
        Organization education1 = new Organization("Coursera", "https://www.coursera.org/course/progfun",
                positions11);
        List<Position> positions22 = new ArrayList<>();
        positions22.add(new Position(DateUtil.of(2011, Month.MARCH), DateUtil.of(2011, Month.APRIL),
        ...
        Organization education2 = new Organization("Luxoft",
                "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366", positions22);
        List<Position> positions33 = new ArrayList<>();
        positions33.add(new Position(DateUtil.of(2005, Month.JANUARY), DateUtil.of(2005, Month.APRIL),
                "3 месяца обучения мобильным IN сетям (Берлин)", null));
        Organization education3 = new Organization("Siemens AG", "http://www.siemens.ru/", positions33);
        List<Position> positions44 = new ArrayList<>();
        positions44.add(new Position(DateUtil.of(1997, Month.SEPTEMBER), DateUtil.of(1998, Month.MARCH),
                "6 месяцев обучения цифровым телефонным сетям (Москва)", null));
        Organization education4 = new Organization("Alcatel", "http://www.alcatel.ru/", positions44);
        List<Position> positions55 = new ArrayList<>();
        positions55.add(new Position(DateUtil.of(1993, Month.SEPTEMBER), DateUtil.of(1996, Month.JULY),
                "Аспирантура (программист С, С++)", null));
        positions55.add(new Position(DateUtil.of(1987, Month.SEPTEMBER), DateUtil.of(1993, Month.JULY),
                "Инженер (программист Fortran, C)", null));
        Organization education5 = new Organization("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                "http://www.ifmo.ru/", positions55);
        List<Position> positions66 = new ArrayList<>();
        positions66.add(new Position(DateUtil.of(1984, Month.SEPTEMBER), DateUtil.of(1987, Month.JUNE),
                "Закончил с отличием", null));
        Organization education6 = new Organization("Заочная физико-техническая школа при МФТИ",
                "http://www.school.mipt.ru/", positions66);
        List<Organization> educationContent = new ArrayList<>();
        Collections.addAll(educationContent, education1, education2, education3, education4, education5, education6);
